...
class Constants {
    ...
    companion object {
        ...
        const val ERROR_HTTP_MESSAGE = "Ooops! Houve um erro ao buscar os usuários. Tente novamente mais tarde."
        const val ERROR_NOT_USERS_MESSAGE = "Vish! Sem usuários por enquanto..."
    }
}